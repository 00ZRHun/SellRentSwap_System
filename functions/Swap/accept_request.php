<?php     
    ...
    $insert_record_sql = "INSERT INTO swap_records(item_id, receiver_id, provider_id, receiver_item_id, status) 
                          VALUES (:item_id, :receiver_id, :provider_id, :receiver_item_id, :status)";
